...
const HeroTitle = () => {
	return (
		<h1 className="w-full text-7xl sm:text-8xl md:text-9xl lg:text-8xl 2xl:text-9xl font-black flex flex-col lg:flex-row gap-3 lg:gap-6 justify-center text-center">
			<a
				href="#exploreSection"
