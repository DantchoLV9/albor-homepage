	...
	return (
		<main className="w-full flex-1 flex flex-col justify-center items-center">
			<div className="flex h-screen flex-col justify-center items-center gap-20 lg:gap-40 w-full lg:w-3/4 px-10">
				...
				<p className="lg:text-xl text-center bg-orange-300/20 px-5 py-2 rounded-full flex justify-center items-center gap-3">
					<svg
						fill="none"
						stroke="currentColor"
						strokeWidth={1.5}
					...
					This project is under active development and not publicly available.
				</p>
			</div>
